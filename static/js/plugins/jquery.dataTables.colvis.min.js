...
ColVis = function( oDTSettings, oInit )
{
	...
	this.s = {
		...
		/**
		 * Overlay animations duration in mS
...
ColVis.prototype = {
	...
	"_fnDomColumnButton": function ( i )
	{
		var
			...
			nButton = document.createElement('button'),
			nSpan = document.createElement('label'),
			dt = this.s.dt;
		...
		$(nSpan).html(
			...
			'<span>'+sTitle+'</span>' )
            .addClass("checkbox ColVis_Checkbox");
	...
	"_fnCollectionShow": function ()
	{
		...
		if ( this.s.sSize == "auto" )
		{
			...
			this.dom.collection.style.width = (iMax + 8) + "px";
		}
		...
		/* This results in a very small delay for the end user but it allows the animations to be
		 * much smoother. If you don't want the animations, then the setTimeout can be removed
		 */
		setTimeout( function () {
